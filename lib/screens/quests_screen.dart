      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            Text('DAILY QUESTS', style: TextStyle(fontFamily: 'Orbitron', fontSize: 13, color: colors.text, fontWeight: FontWeight.bold)),
          ],
        ),
        centerTitle: true,
      ),
      body: SafeArea(
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return _QuestCard(quest: q, colors: colors).animate().fadeIn(delay: Duration(milliseconds: 100 * index)).slideX();
          },
        ),
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isDone ? colors.buttonBorder.withOpacity(0.15) : colors.hudBg.withOpacity(0.5),
        borderRadius: BorderRadius.circular(20),
        border: Border.all(
          color: isDone ? colors.buttonBorder : colors.buttonBorder.withOpacity(0.2),
          width: isDone ? 2 : 1,
        ),
        boxShadow: isDone ? [
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
               Expanded(
                  child: Text(
                    ...
                    style: TextStyle(fontFamily: 'Orbitron', fontSize: 12, color: colors.text, fontWeight: FontWeight.bold),
                  )
               ),
               Container(
                 ...
                 child: Row(
                   children: [
                     ...
                     Text(
                       '+${quest.coinReward}',
                       style: const TextStyle(fontFamily: 'Orbitron', fontSize: 11, color: Colors.amber, fontWeight: FontWeight.bold),
                     ),
                   ],
                 ),
               ),
          ...
          Text(
            quest.description,
            style: TextStyle(fontFamily: 'Orbitron', fontSize: 10, color: colors.text.withOpacity(0.7)),
          ),
          ...
          Row(
            children: [
               ...
               Text(
                 ...
                 style: TextStyle(fontFamily: 'Orbitron', fontSize: 10, color: colors.text),
               )
            ],
          )
        ],
